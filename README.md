...
This paper has been submitted to Elsevier Expert Systems with Applications. If you use the code given here, please cite this paper <br>
Cuneyt Akinlar, Hatice Kubra Kucukkartal, Cihan Topal. Accurate CNN-based Pupil Segmentation with an Ellipse Fit Error Regularization Term. Submitted to Expert Systems with Applications.
