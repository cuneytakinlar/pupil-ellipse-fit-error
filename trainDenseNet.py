    ...
    for image_features in dataSetByBatch:            
        ...
        if current_batch % DIV == 0:
            ...
            if processingMode == "train":
                ...
                predict = get_predictions(output)  # Extract the result
...
def main():
    ...
    Size_X, Size_Y, batchSize = 320, 240, 24
...
#    model.load_state_dict(torch.load(model_file_name))
    ...
    for epoch in range(1, noEpochs+1, 1):
        ...
        savename = f"{trained_model_path}/model{epoch:02d}.pt"
